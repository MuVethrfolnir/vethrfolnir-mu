...
public class MassSkillUse extends MuWritePacket {
	...
	public void write(MuClient client, ByteBuf buff, Object... params) {
		...
		writeC(buff, 0x00);
		writeC(buff, 0x1E);
		writeSh(buff, skillId, ByteOrder.BIG_ENDIAN);
		writeSh(buff, entity.getWorldIndex(), ByteOrder.BIG_ENDIAN); // skill id
		writeArray(buff, positioning.getX(), positioning.getY(), positioning.getHeading() << 4);
	}
